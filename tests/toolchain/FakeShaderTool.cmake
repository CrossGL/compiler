...
function(fake_glslang_write_partial_native_artifact)
  ...
  string(REGEX REPLACE "\\.(comp|graphics)\\.glsl$" ".glsl"
...
elseif(FAKE_TOOL_NAME STREQUAL "glslangValidator")
  ...
  elseif(fake_glsl_stage STREQUAL "vert")
    fake_tool_expect_arg_present("${fake_tool_args}" "-l")
    fake_tool_expect_arg_present("${fake_tool_args}" "-DCROSSGL_STAGE_VERTEX=1")
    fake_tool_expect_source_suffix("${fake_tool_args}" "\\.graphics\\.glsl")
  elseif(fake_glsl_stage STREQUAL "frag")
    fake_tool_expect_arg_present("${fake_tool_args}" "-l")
    fake_tool_expect_arg_present("${fake_tool_args}" "-DCROSSGL_STAGE_FRAGMENT=1")
    fake_tool_expect_source_suffix("${fake_tool_args}" "\\.graphics\\.glsl")
  else()
    message(FATAL_ERROR
