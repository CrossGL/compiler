...
add_test(NAME cglc_build_directx_source_package_fake_dxc_success
  COMMAND ${CMAKE_COMMAND}
    ...
    "-DEXPECTED_MANIFEST_JSON_FIELDS=targetLegalizationToolRequirements.packageMode=native|targetLegalizationToolRequirements.requiredToolCount=2|targetLegalizationToolRequirements.missingToolCount=0|targetLegalizationToolRequirements.optionalNativeToolMissing=false|targetLegalizationToolRequirements.optionalNativeToolStatus=not-required|packageArtifactRequirements.packageMode=native|packageArtifactRequirements.requiresNativeBinaryStatus=false"
    "-DEXPECTED_DEBUG_METADATA_JSON_FIELDS=targetDecision.selectedTargetPackageMode=native|targetDecision.selectedTargetSourcePackageSupported=true|targetDecision.selectedTargetRequiredToolCount=2|targetDecision.selectedTargetMissingToolCount=0|targetDecision.selectedTargetOptionalNativeToolMissing=false|targetDecision.selectedTargetOptionalNativeToolStatus=not-required"
...
set(CROSSGL_DIRECTX_COMPUTE_BACKEND_SOURCE_MAP_PACKAGE_INSPECT_FIELDS
  "debugArtifacts.backendSourceMap.artifactPresent=true|debugArtifacts.backendSourceMap.exists=true|debugArtifacts.backendSourceMap.health=ok|debugArtifacts.backendSourceMap.path=backend/directx/StorageBufferComputeShader.backend-source-map.json|debugArtifacts.backendSourceMap.schemaVersion=1|debugArtifacts.backendSourceMap.kind=crossgl.backendSourceMap|debugArtifacts.backendSourceMap.target=directx|debugArtifacts.backendSourceMap.module=StorageBufferComputeShader|debugArtifacts.backendSourceMap.mappingGranularity=statement|debugArtifacts.backendSourceMap.sourceBackend=crossgl-hir|debugArtifacts.backendSourceMap.targetBackend=hlsl|debugArtifacts.backendSourceMap.backendLanguage=hlsl|debugArtifacts.backendSourceMap.checks.identityMatchesContract=true|debugArtifacts.backendSourceMap.checks.targetMatchesPackage=true|debugArtifacts.backendSourceMap.checks.moduleMatchesPackage=true|debugArtifacts.backendSourceMap.checks.mappingGranularityMatchesContract=true|debugArtifacts.backendSourceMap.checks.sourceBackendPresent=true|debugArtifacts.backendSourceMap.checks.targetBackendMatchesBackendLanguage=true|debugArtifacts.backendSourceMap.checks.backendLanguagePresent=true|debugArtifacts.backendSourceMap.checks.backendLineCountPresent=true|debugArtifacts.backendSourceMap.checks.backendLineCountMatchesSource=true|debugArtifacts.backendSourceMap.checks.backendSpansWithinSource=true|debugArtifacts.backendSourceMap.checks.mappingCountMatchesMappings=true")
crossgl_add_python_expect_test(
...
crossgl_add_python_expect_test(
  ...
  DEFINITIONS
    ...
    "-DEXPECTED_DEBUG_METADATA_JSON_FIELDS=hirSourceLocations.types.0.location.file=generated/from-translator.cgl|hirSourceLocations.types.0.originalLocation.file=shaders/original.crossgl"
    "-DEXPECTED_HIR_SOURCE_MAP_JSON_FIELDS=hirSourceLocations.types.0.location.file=generated/from-translator.cgl|hirSourceLocations.types.0.originalLocation.file=shaders/original.crossgl"
    "-DEXPECTED_BACKEND_SOURCE_MAP_JSON_FIELDS=schemaVersion=1|kind=crossgl.backendSourceMap|target=directx|module=StorageBufferComputeShader|sourceRemap.path=ir/source-remap-provenance.json|sourceRemap.target=cgl|sourceRemap.sourceBackend=cgl|sourceRemap.variant=debug|sourceRemap.mappingGranularity=file|sourceRemap.generatedFile=generated/from-translator.cgl|sourceRemap.mappingCount=1|sourceRemap.sha256.value=${CROSSGL_SOURCE_REMAP_FULL_FILE_SHA256}|sourceRemap.sizeBytes=${CROSSGL_SOURCE_REMAP_FULL_FILE_SIZE_BYTES}"
    "-DEXPECTED_PACKAGE_INSPECT_JSON_FIELDS=summary.artifactCount=8|debugArtifacts.health=ok|${CROSSGL_DIRECTX_COMPUTE_BACKEND_SOURCE_MAP_PACKAGE_INSPECT_FIELDS}|debugArtifacts.backendSourceMap.sourceRemapPresent=true|debugArtifacts.backendSourceMap.sourceRemapPath=ir/source-remap-provenance.json|debugArtifacts.backendSourceMap.sourceRemapGeneratedFile=generated/from-translator.cgl|debugArtifacts.backendSourceMap.sourceRemapTarget=cgl|debugArtifacts.backendSourceMap.sourceRemapMappingGranularity=file|debugArtifacts.backendSourceMap.sourceRemapMappingCount=1|debugArtifacts.backendSourceMap.sourceRemapSourceBackend=cgl|debugArtifacts.backendSourceMap.sourceRemapVariant=debug|debugArtifacts.backendSourceMap.sourceRemapSha256=${CROSSGL_SOURCE_REMAP_FULL_FILE_SHA256}|debugArtifacts.backendSourceMap.sourceRemapSizeBytes=${CROSSGL_SOURCE_REMAP_FULL_FILE_SIZE_BYTES}|debugArtifacts.backendSourceMap.checks.sourceRemapPathPackageRelative=true|debugArtifacts.backendSourceMap.checks.sourceRemapGeneratedFilePackageRelative=true|debugArtifacts.backendSourceMap.checks.sourceRemapHashPresent=true|debugArtifacts.backendSourceMap.checks.sourceRemapMappingCountPositive=true|debugArtifacts.backendSourceMap.checks.sourceRemapMatchesProvenance=true|debugArtifacts.sourceRemap.artifactPresent=true|debugArtifacts.sourceRemap.exists=true|debugArtifacts.sourceRemap.health=ok|debugArtifacts.sourceRemap.path=ir/source-remap-provenance.json|debugArtifacts.sourceRemap.target=directx|debugArtifacts.sourceRemap.generatedFile=generated/from-translator.cgl|debugArtifacts.sourceRemap.mappingCount=1|debugArtifacts.sourceRemap.sourceSha256=${CROSSGL_SOURCE_REMAP_FULL_FILE_SHA256}|debugArtifacts.sourceRemap.sourceSizeBytes=${CROSSGL_SOURCE_REMAP_FULL_FILE_SIZE_BYTES}|debugArtifacts.sourceRemap.sourceRemapTarget=cgl|debugArtifacts.sourceRemap.sourceRemapMappingGranularity=file|debugArtifacts.sourceRemap.sourceRemapSourceBackend=cgl|debugArtifacts.sourceRemap.sourceRemapVariant=debug|debugArtifacts.sourceRemap.checks.identityMatchesContract=true|debugArtifacts.sourceRemap.checks.targetMatchesPackage=true|debugArtifacts.sourceRemap.checks.mappingGranularityMatchesContract=true|debugArtifacts.sourceRemap.checks.sourceHashPresent=true"
    -DDEBUG_METADATA_JSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/debug-metadata-v11.schema.json
    -DHIR_SOURCE_MAP_JSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/hir-source-map-v7.schema.json
    -DBACKEND_SOURCE_MAP_JSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/backend-source-map-v1.schema.json
    -DSOURCE_REMAP_PROVENANCE_JSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/source-remap-provenance-v1.schema.json
...
function(crossgl_add_directx_compute_fake_dxc_package_inspect_test)
  ...
  if(CROSSGL_DIRECTX_FAKE_DXC_INSPECT_EXPECTED_NATIVE_BINARY_STATUS STREQUAL
    ...
    set(directx_fake_dxc_inspect_extra_json_fields
      "|nativeArtifactDescriptor.artifactPath=backend/directx/StorageBufferComputeShader.dxil|nativeArtifactDescriptor.optimizationLevel=O1|nativeArtifactDescriptor.optimizationEvidence.requestedLevel=O1|nativeArtifactDescriptor.optimizationEvidence.effectiveLevel=O3|nativeArtifactDescriptor.optimizationEvidence.policy=crossgl-to-dxc-optimization-map|nativeArtifactDescriptor.optimizationEvidence.status=applied|nativeArtifactDescriptor.optimizationEvidence.tool=dxc|nativeArtifactDescriptor.optimizationEvidence.toolFlag=-O3|nativeArtifactDescriptor.optimizationEvidence.profile=compute=cs_6_0|nativeArtifactDescriptor.validationStatus=not-run|nativeArtifactDescriptor.checks.nativeBinaryStatusMatchesPackage=true|nativeArtifactDescriptor.checks.artifactHashMatchesFile=true|nativeArtifactDescriptor.checks.sizeBytesMatchesFile=true|nativeArtifactDescriptor.checks.validationStatusMatchesNativeStatus=true|packageArtifactRequirements.packageMode=native|packageArtifactRequirements.requiresNativeBinaryStatus=false|packageArtifactRequirements.allowsPlannedNativeBinary=false|packageArtifactRequirements.allowsPlannedNativeSourceEvidence=false|targetLegalizationEvidence.packageMode=native|targetLegalizationEvidence.manifestToolRequirements.packageMode=native|targetLegalizationEvidence.manifestToolRequirements.requiredToolCount=2|targetLegalizationEvidence.manifestToolRequirements.missingToolCount=0|targetLegalizationEvidence.manifestToolRequirements.optionalNativeToolStatus=not-required")
    set(directx_fake_dxc_inspect_extra_native_descriptor_paths
  ...
  set(inspect_definitions
    ...
    "-DEXPECTED_NATIVE_ARTIFACT_DESCRIPTOR_JSON_FIELDS=target=directx|binaryKind=directx.dxil|sourcePath=backend/directx/StorageBufferComputeShader.hlsl${directx_fake_dxc_inspect_raw_descriptor_native_binary_status_field}${directx_fake_dxc_inspect_extra_native_descriptor_fields}"
      "-DEXPECTED_JSON_ARRAY_LENGTHS=rootFiles=3|artifacts=7|${CROSSGL_DIRECTX_FAKE_DXC_INSPECT_EXPECTED_DIAGNOSTICS_ARRAY_LENGTHS}"
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/package-inspect-v1.schema.json
    -DNATIVE_ARTIFACT_JSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/native-artifact-v0.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
...
set(CROSSGL_DIRECTX_GRAPHICS_BACKEND_SOURCE_MAP_PACKAGE_INSPECT_FIELDS
  "debugArtifacts.backendSourceMap.artifactPresent=true|debugArtifacts.backendSourceMap.exists=true|debugArtifacts.backendSourceMap.health=ok|debugArtifacts.backendSourceMap.path=backend/directx/DirectXGraphicsResourceShader.backend-source-map.json|debugArtifacts.backendSourceMap.schemaVersion=1|debugArtifacts.backendSourceMap.kind=crossgl.backendSourceMap|debugArtifacts.backendSourceMap.target=directx|debugArtifacts.backendSourceMap.module=DirectXGraphicsResourceShader|debugArtifacts.backendSourceMap.mappingGranularity=statement|debugArtifacts.backendSourceMap.sourceBackend=crossgl-hir|debugArtifacts.backendSourceMap.targetBackend=hlsl|debugArtifacts.backendSourceMap.backendLanguage=hlsl|debugArtifacts.backendSourceMap.checks.identityMatchesContract=true|debugArtifacts.backendSourceMap.checks.targetMatchesPackage=true|debugArtifacts.backendSourceMap.checks.moduleMatchesPackage=true|debugArtifacts.backendSourceMap.checks.mappingGranularityMatchesContract=true|debugArtifacts.backendSourceMap.checks.sourceBackendPresent=true|debugArtifacts.backendSourceMap.checks.targetBackendMatchesBackendLanguage=true|debugArtifacts.backendSourceMap.checks.backendLanguagePresent=true|debugArtifacts.backendSourceMap.checks.backendLineCountPresent=true|debugArtifacts.backendSourceMap.checks.backendLineCountMatchesSource=true|debugArtifacts.backendSourceMap.checks.backendSpansWithinSource=true|debugArtifacts.backendSourceMap.checks.mappingCountMatchesMappings=true")
crossgl_add_python_expect_test(
...
function(crossgl_add_opengl_compute_fake_glslang_package_inspect_test)
  ...
  set(inspect_definitions
    ...
    "-DEXPECTED_JSON_ARRAY_LENGTHS=rootFiles=3|artifacts=7|${CROSSGL_OPENGL_FAKE_GLSLANG_INSPECT_EXPECTED_DIAGNOSTICS_ARRAY_LENGTHS}"
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/package-inspect-v1.schema.json
    -DNATIVE_ARTIFACT_JSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/native-artifact-v0.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
