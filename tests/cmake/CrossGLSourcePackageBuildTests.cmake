...
kernel void compute_main(device float4* values [[buffer(0)]], array<texture2d<float>, COUNT> colorMaps [[texture(2)]], array<sampler, COUNT> linearSamplers [[sampler(5)]]) {
  ...
  add_test(NAME cglc_build_metal_dynamic_nested_struct_function_parameter_array_write_source_package
    COMMAND ${CMAKE_COMMAND}
      ...
      "-DEXPECTED_DIAGNOSTICS_JSON_ARRAY_LENGTHS=diagnostics=0"
      -P ${CMAKE_CURRENT_SOURCE_DIR}/tests/cmake/ExpectCommand.cmake)
  set(CROSSGL_METAL_RUNTIME_RESOURCE_DESCRIPTOR_ARRAY_TABLE_SNIPPET [=[kernel void compute_main(device float4* values [[buffer(0)]], constant CrossGLMetalRuntimeResourceDescriptorArrayTable& maps [[buffer(1)]]) {]=])
  add_test(NAME cglc_build_metal_runtime_texture_descriptor_array_policy_source_package
    COMMAND ${CMAKE_COMMAND}
      ...
      "-DEXPECTED_REFLECTION_JSON_ARRAY_LENGTHS=resources=2|targetResourceBindings=2|workgroupSizes=1|manualTextureCompareKernels=0"
      "-DEXPECTED_REFLECTION_TARGET_FIELDS=values.sourceType=vec4*|values.metalType=device float4*|values.bindingClass=buffer|values.argumentIndex=0|values.storageBufferLayout.elementType=vec4|values.storageBufferLayout.layout=metal-device|maps.sourceType=sampler2D[]|maps.metalType=constant CrossGLMetalRuntimeResourceDescriptorArrayTable&|maps.addressSpace=constant|maps.abi=kernelArgument|maps.bindingClass=buffer|maps.argumentIndex=1|maps.set=0|maps.binding=1|maps.arraySize=|maps.arrayDimensions.0.kind=runtime"
  ...
  add_test(NAME cglc_build_metal_runtime_resource_array_source_package
    COMMAND ${CMAKE_COMMAND}
      ...
      -DMODE=metal-build
      "-DEXPECTED_METAL_SOURCE_SNIPPET=constant CrossGLMetalRuntimeResourceDescriptorArrayTable& linearSamplers [[buffer(2)]]"
      ...
      "-DEXPECTED_REFLECTION_JSON_ARRAY_LENGTHS=resources=3|targetResourceBindings=3|workgroupSizes=1"
      "-DEXPECTED_REFLECTION_TARGET_FIELDS=values.sourceType=vec4*|values.metalType=device float4*|values.bindingClass=buffer|values.argumentIndex=0|values.storageBufferLayout.elementType=vec4|values.storageBufferLayout.layout=metal-device|maps.sourceType=sampler2D[]|maps.metalType=constant CrossGLMetalRuntimeResourceDescriptorArrayTable&|maps.addressSpace=constant|maps.abi=kernelArgument|maps.bindingClass=buffer|maps.argumentIndex=1|maps.set=0|maps.binding=1|maps.arraySize=|maps.arrayDimensions.0.kind=runtime|linearSamplers.sourceType=sampler[]|linearSamplers.metalType=constant CrossGLMetalRuntimeResourceDescriptorArrayTable&|linearSamplers.addressSpace=constant|linearSamplers.abi=kernelArgument|linearSamplers.bindingClass=buffer|linearSamplers.argumentIndex=2|linearSamplers.set=0|linearSamplers.binding=2|linearSamplers.arraySize=|linearSamplers.arrayDimensions.0.kind=runtime"
