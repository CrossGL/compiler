...
add_test(NAME cglc_dump_debug_selected_target_diagnostics
  COMMAND ${CMAKE_COMMAND}
    ...
    -DSTAGE=debug
    -DMODE=dump-stage
    "-DEXPECTED_JSON_FIELDS=targetDecision.requestedTarget=directx|targetDecision.selectedTarget=directx|targetDecision.selectedTargetSourcePackageSupported=false|targetDecision.selectedTargetPackageMode=unsupported|targetDecision.selectedTargetPackageBuildSupported=false|targetDecision.selectedTargetMissingCapabilityCount=2|targetDecision.selectedTargetDiagnosticCount=1|targetDecision.diagnostics.0.code=directx.unsupported-runtime-resource-array|targetDecision.diagnostics.0.target=directx"
    "-DEXPECTED_JSON_ARRAY_CONTAINS=targetDecision.selectedTargetMissingCapabilities=directx.backend.hlsl-lowering|targetDecision.selectedTargetMissingCapabilities=directx.diagnostic.directx.unsupported-runtime-resource-array|targetDecision.diagnostics.0.capabilities=directx.backend.hlsl-lowering|targetDecision.diagnostics.0.capabilities=directx.diagnostic.directx.unsupported-runtime-resource-array"
    -P ${CMAKE_CURRENT_SOURCE_DIR}/tests/cmake/ExpectCommand.cmake)
...
crossgl_add_python_expect_test(
  ...
  DEFINITIONS
    ...
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/debug-metadata-v11.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py
    "-DEXPECTED_JSON_FIELDS=schemaVersion=11|targetDecision.requestedTarget=directx|targetDecision.selectedTarget=directx|targetDecision.selectedTargetSourcePackageSupported=false|targetDecision.selectedTargetPackageMode=unsupported|targetDecision.selectedTargetMissingCapabilityCount=2|targetDecision.selectedTargetDiagnosticCount=1|targetDecision.diagnostics.0.code=directx.unsupported-runtime-resource-array|targetDecision.diagnostics.0.severity=error"
    "-DEXPECTED_JSON_ARRAY_CONTAINS=targetDecision.selectedTargetMissingCapabilities=directx.backend.hlsl-lowering|targetDecision.selectedTargetMissingCapabilities=directx.diagnostic.directx.unsupported-runtime-resource-array|targetDecision.diagnostics.0.capabilities=directx.backend.hlsl-lowering|targetDecision.diagnostics.0.capabilities=directx.diagnostic.directx.unsupported-runtime-resource-array")
...
add_test(NAME cglc_explain_targets_native_predicate_unsupported
  COMMAND ${CMAKE_COMMAND}
    ...
    -DINPUT=${CROSSGL_DIRECTX_RUNTIME_TEXTURE_RESOURCE_ARRAY_CONFLICT_SHADER}
    -DMODE=explain-targets
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|module=DirectXRuntimeTextureResourceArrayConflictShader|buildableTargetCount=0|recommendedTarget=null|recommendedPackageMode=null"
