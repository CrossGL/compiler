...
crossgl_add_python_expect_test(
  ...
  DEFINITIONS
    ...
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|kind=crossgl.backendSourceMap|target=directx|module=StorageBufferComputeShader|mappingGranularity=statement|sourceBackend=crossgl-hir|targetBackend=hlsl|backend.language=hlsl|backend.lineCount=7|sourceRemap.generatedFile=generated/from-translator.cgl|sourceRemap.mappingCount=1|sourceRemap.sizeBytes=592|mappingCount=2|mappings.0.stage=compute|mappings.0.entryPoint=main|mappings.0.function=main|mappings.0.statementKind=assign|mappings.0.name=values[0]|mappings.0.backend.startLine=5|mappings.0.backend.startColumn=1|mappings.0.backend.offset=156|mappings.0.backend.length=16|mappings.0.backend.endLine=5|mappings.0.backend.endColumn=17|mappings.0.backend.endOffset=172|mappings.0.location.file=generated/from-translator.cgl|mappings.0.location.line=8|mappings.0.originalLocation.file=shaders/original.crossgl|mappings.0.originalLocation.line=47|mappings.1.statementKind=return|mappings.1.backend.startLine=6|mappings.1.backend.offset=173|mappings.1.backend.length=9|mappings.1.backend.endOffset=182|mappings.1.originalLocation.line=48"
...
crossgl_add_python_expect_test(
  ...
  DEFINITIONS
    ...
    "-DSOURCE_MAP_FILTER_ARGS=--logical-input|generated/from-translator.cgl|--source-remap|${CMAKE_CURRENT_SOURCE_DIR}/tests/fixtures/source-remap-v1-full-file-report-metadata.json"
    "-DEXPECTED_JSON_ARRAY_LENGTHS=mappings=2"
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|kind=crossgl.backendSourceMap|target=vulkan|module=StorageBufferComputeShader|mappingGranularity=statement|sourceBackend=crossgl-hir|targetBackend=spvasm|backend.language=spvasm|backend.lineCount=26|sourceRemap.target=cgl|sourceRemap.generatedFile=generated/from-translator.cgl|sourceRemap.mappingGranularity=file|sourceRemap.mappingCount=1|sourceRemap.sizeBytes=592|sourceRemap.sourceBackend=cgl|sourceRemap.variant=debug|mappingCount=2|mappings.0.stage=compute|mappings.0.entryPoint=main|mappings.0.function=main|mappings.0.statementKind=assign|mappings.0.name=values[0]|mappings.0.backend.startLine=23|mappings.0.backend.startColumn=1|mappings.0.backend.offset=954|mappings.0.backend.length=123|mappings.0.backend.endLine=24|mappings.0.backend.endColumn=31|mappings.0.backend.endOffset=1077|mappings.0.location.file=generated/from-translator.cgl|mappings.0.location.line=8|mappings.0.originalLocation.file=shaders/original.crossgl|mappings.0.originalLocation.line=47|mappings.1.statementKind=return|mappings.1.name=return|mappings.1.backend.startLine=25|mappings.1.backend.offset=1078|mappings.1.backend.length=8|mappings.1.backend.endLine=25|mappings.1.backend.endOffset=1086|mappings.1.originalLocation.line=48"
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/backend-source-map-v1.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
crossgl_add_python_expect_test(
...
crossgl_add_python_expect_test(
  ...
  DEFINITIONS
    ...
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
crossgl_add_python_expect_test(
  NAME cglc_dump_backend_source_map_vulkan_for_header_statements
  DEFINITIONS
    -DCGLC=$<TARGET_FILE:cglc>
    -DINPUT=${CMAKE_CURRENT_SOURCE_DIR}/tests/fixtures/ForFoldedUpdateComputeShader.cgl
    -DTARGET=vulkan
    -DSTAGE=backend-source-map
    -DMODE=dump-stage
    "-DEXPECTED_JSON_ARRAY_LENGTHS=mappings=5"
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|kind=crossgl.backendSourceMap|target=vulkan|module=ForFoldedUpdateComputeShader|mappingGranularity=statement|sourceBackend=crossgl-hir|targetBackend=spvasm|backend.language=spvasm|backend.lineCount=55|mappingCount=5|mappings.0.statementKind=decl|mappings.0.name=i|mappings.0.backend.startLine=30|mappings.0.backend.endLine=30|mappings.0.location.line=7|mappings.1.statementKind=decl|mappings.1.name=x|mappings.1.backend.startLine=38|mappings.2.statementKind=assign|mappings.2.name=values[i]|mappings.2.backend.startLine=42|mappings.3.statementKind=assign|mappings.3.name=i|mappings.3.backend.startLine=49|mappings.3.backend.endLine=51|mappings.3.location.line=7|mappings.4.statementKind=return|mappings.4.name=return|mappings.4.backend.startLine=54"
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/backend-source-map-v1.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
crossgl_add_python_expect_test(
  NAME cglc_dump_backend_source_map_vulkan_for_token_update_statement
  DEFINITIONS
    -DCGLC=$<TARGET_FILE:cglc>
    -DINPUT=${CMAKE_CURRENT_SOURCE_DIR}/tests/fixtures/ForComputeShader.cgl
    -DTARGET=vulkan
    -DSTAGE=backend-source-map
    -DMODE=dump-stage
    "-DEXPECTED_JSON_ARRAY_LENGTHS=mappings=5"
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|kind=crossgl.backendSourceMap|target=vulkan|module=ForComputeShader|mappingGranularity=statement|sourceBackend=crossgl-hir|targetBackend=spvasm|backend.language=spvasm|backend.lineCount=55|mappingCount=5|mappings.0.statementKind=decl|mappings.0.name=i|mappings.0.backend.startLine=30|mappings.0.location.line=7|mappings.1.statementKind=decl|mappings.1.name=x|mappings.1.backend.startLine=38|mappings.2.statementKind=assign|mappings.2.name=values[i]|mappings.2.backend.startLine=42|mappings.3.statementKind=assign|mappings.3.name=i|mappings.3.backend.startLine=49|mappings.3.backend.endLine=51|mappings.3.location.line=7|mappings.3.location.column=30|mappings.3.location.length=3|mappings.4.statementKind=return|mappings.4.name=return|mappings.4.backend.startLine=54"
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/backend-source-map-v1.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
crossgl_add_python_expect_test(
  ...
  DEFINITIONS
    ...
    "-DSOURCE_MAP_FILTER_ARGS=--logical-input|generated/from-translator.cgl|--source-remap|${CMAKE_CURRENT_SOURCE_DIR}/tests/fixtures/source-remap-v1-full-file-report-metadata.json"
    "-DEXPECTED_JSON_ARRAY_LENGTHS=mappings=2"
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|kind=crossgl.backendSourceMap|target=opengl|module=StorageBufferComputeShader|mappingGranularity=statement|sourceBackend=crossgl-hir|targetBackend=glsl|backend.language=glsl|backend.lineCount=13|sourceRemap.target=cgl|sourceRemap.generatedFile=generated/from-translator.cgl|sourceRemap.mappingGranularity=file|sourceRemap.mappingCount=1|sourceRemap.sizeBytes=592|sourceRemap.sourceBackend=cgl|sourceRemap.variant=debug|mappingCount=2|mappings.0.stage=compute|mappings.0.entryPoint=compute_main|mappings.0.function=main|mappings.0.statementKind=assign|mappings.0.name=values[0]|mappings.0.backend.startLine=10|mappings.0.backend.startColumn=1|mappings.0.backend.offset=194|mappings.0.backend.length=16|mappings.0.backend.endLine=10|mappings.0.backend.endColumn=17|mappings.0.backend.endOffset=210|mappings.0.location.file=generated/from-translator.cgl|mappings.0.location.line=8|mappings.0.originalLocation.file=shaders/original.crossgl|mappings.0.originalLocation.line=47|mappings.1.statementKind=return|mappings.1.backend.startLine=11|mappings.1.backend.offset=211|mappings.1.backend.length=9|mappings.1.backend.endLine=11|mappings.1.backend.endOffset=220|mappings.1.originalLocation.line=48"
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/backend-source-map-v1.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
crossgl_add_python_expect_test(
  ...
  DEFINITIONS
    ...
    "-DSOURCE_MAP_FILTER_ARGS=--logical-input|generated/from-translator.cgl|--source-remap|${CMAKE_CURRENT_SOURCE_DIR}/tests/fixtures/source-remap-v1-full-file-report-metadata.json"
    "-DEXPECTED_JSON_ARRAY_LENGTHS=mappings=2"
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|kind=crossgl.backendSourceMap|target=metal|module=StorageBufferComputeShader|mappingGranularity=statement|sourceBackend=crossgl-hir|targetBackend=msl|backend.language=msl|backend.lineCount=8|sourceRemap.target=cgl|sourceRemap.generatedFile=generated/from-translator.cgl|sourceRemap.mappingGranularity=file|sourceRemap.mappingCount=1|sourceRemap.sizeBytes=592|sourceRemap.sourceBackend=cgl|sourceRemap.variant=debug|mappingCount=2|mappings.0.stage=compute|mappings.0.entryPoint=compute_main|mappings.0.function=main|mappings.0.statementKind=assign|mappings.0.name=values[0]|mappings.0.backend.startLine=5|mappings.0.backend.startColumn=1|mappings.0.backend.offset=48|mappings.0.backend.length=16|mappings.0.backend.endLine=5|mappings.0.backend.endColumn=17|mappings.0.backend.endOffset=64|mappings.0.location.file=generated/from-translator.cgl|mappings.0.location.line=8|mappings.0.originalLocation.file=shaders/original.crossgl|mappings.0.originalLocation.line=47|mappings.1.statementKind=return|mappings.1.backend.startLine=6|mappings.1.backend.offset=65|mappings.1.backend.length=9|mappings.1.backend.endLine=6|mappings.1.backend.endOffset=74|mappings.1.originalLocation.line=48"
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/backend-source-map-v1.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
