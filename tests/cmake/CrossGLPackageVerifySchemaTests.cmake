...
if(CROSSGL_HAS_METAL_NATIVE_TOOLS)
  crossgl_add_package_verify_json_schema_test(
    ...
    EXPECTED_JSON_FIELDS
      "schemaVersion=1|success=true|summary.module=SimpleShader|summary.target=metal|summary.nativeBinaryStatus=null|summary.artifactCount=9|summary.debugArtifactsPresent=true|summary.nativeArtifactDescriptor.artifactPresent=true|summary.nativeArtifactDescriptor.descriptorExists=true|summary.nativeArtifactDescriptor.health=ok|summary.nativeArtifactDescriptor.path=backend/metal/SimpleShader.native-artifact.json|diagnosticCounts.error=0"
    EXPECTED_MANIFEST_JSON_FIELDS
