...
if(CROSSGL_HAS_VULKAN_NATIVE_TOOLS)
  ...
  add_test(NAME cglc_build_vulkan_runtime_texture_descriptor_array_conflict_planned_failure
    COMMAND ${CMAKE_COMMAND}
      ...
      "-DEXPECTED_DIAGNOSTIC_FIELD_CONTAINS=message=target 'vulkan' cannot build a package for this module|message=vulkan.backend.vulkan-prototype-package|message=vulkan.diagnostic.vulkan.prototype-unsupported-runtime-resource-array|message=TargetLegalizationResult: state=rejected|message=provenance=unsupported-native-form|message=target-legalization.v1.vulkan.capability.missing.vulkan.diagnostic.vulkan.prototype-unsupported-runtime-resource-array"
      -DMODE=planned-build-failure
      -P ${CMAKE_CURRENT_SOURCE_DIR}/tests/cmake/ExpectCommand.cmake)
  ...
  crossgl_add_python_expect_test(
    ...
    DEFINITIONS
      ...
      -DTOOLCHAIN_DISABLE_FALLBACK=ON
      -DMODE=package-inspect-source-package
      "-DEXPECTED_JSON_FIELDS=schemaVersion=1|packageFormat=directory|summary.module=StorageBufferComputeShader|summary.target=vulkan|summary.nativeBinaryStatus=null|summary.artifactCount=7|vulkanNativeProfile.health=ok|vulkanNativeProfile.nativeProfileExists=true|vulkanNativeProfile.disassemblyStatus=emitted|vulkanNativeProfile.disassemblyPath=backend/vulkan/StorageBufferComputeShader.disassembly.spvasm|vulkanNativeProfile.disassemblyExists=true|vulkanNativeProfile.checks.emittedDisassemblyExists=true|artifacts.0.name=backendAssembly|artifacts.1.name=nativeBinary|artifacts.2.name=nativeProfile|artifacts.5.name=nativeArtifactDescriptor|artifacts.5.path=backend/vulkan/StorageBufferComputeShader.native-artifact.json|artifacts.5.exists=true|artifacts.6.name=targetExplanation|artifacts.6.path=ir/target-explanation.json|artifacts.6.exists=true|manifest.artifacts.nativeProfile=backend/vulkan/StorageBufferComputeShader.profile.json|manifest.artifacts.nativeArtifactDescriptor=backend/vulkan/StorageBufferComputeShader.native-artifact.json|manifest.artifacts.targetExplanation=ir/target-explanation.json|nativeArtifactDescriptor.health=ok|nativeArtifactDescriptor.target=vulkan|nativeArtifactDescriptor.binaryKind=vulkan.spirv-module|nativeArtifactDescriptor.sourcePath=backend/vulkan/StorageBufferComputeShader.spvasm|nativeArtifactDescriptor.artifactPath=backend/vulkan/StorageBufferComputeShader.spv|nativeArtifactDescriptor.validationStatus=validated"
      "-DEXPECTED_NATIVE_ARTIFACT_DESCRIPTOR_JSON_FIELDS=target=vulkan|binaryKind=vulkan.spirv-module|sourcePath=backend/vulkan/StorageBufferComputeShader.spvasm|artifactPath=backend/vulkan/StorageBufferComputeShader.spv|validationStatus=validated"
      "-DEXPECTED_JSON_ARRAY_LENGTHS=artifacts=7|diagnostics.diagnostics=0"
      -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/package-inspect-v1.schema.json
      -DNATIVE_ARTIFACT_JSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/native-artifact-v0.schema.json
      -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
  crossgl_add_python_expect_test(
    ...
    DEFINITIONS
      ...
      -DTOOLCHAIN_DISABLE_FALLBACK=ON
      -DMODE=package-inspect-source-package
      "-DEXPECTED_JSON_FIELDS=schemaVersion=1|packageFormat=directory|summary.module=StorageBufferComputeShader|summary.target=vulkan|summary.nativeBinaryStatus=null|summary.artifactCount=7|vulkanNativeProfile.health=ok|vulkanNativeProfile.nativeProfileExists=true|vulkanNativeProfile.disassemblyStatus=failed|vulkanNativeProfile.disassemblyPath=null|vulkanNativeProfile.disassemblyExists=null|vulkanNativeProfile.checks.nativeBinaryMatchesManifest=true|vulkanNativeProfile.checks.emittedDisassemblyExists=null|artifacts.1.name=nativeBinary|artifacts.1.exists=true|artifacts.5.name=nativeArtifactDescriptor|artifacts.5.path=backend/vulkan/StorageBufferComputeShader.native-artifact.json|artifacts.5.exists=true|artifacts.6.name=targetExplanation|artifacts.6.path=ir/target-explanation.json|artifacts.6.exists=true|manifest.artifacts.nativeBinary=backend/vulkan/StorageBufferComputeShader.spv|manifest.artifacts.nativeArtifactDescriptor=backend/vulkan/StorageBufferComputeShader.native-artifact.json|manifest.artifacts.targetExplanation=ir/target-explanation.json|nativeArtifactDescriptor.health=ok|nativeArtifactDescriptor.target=vulkan|nativeArtifactDescriptor.binaryKind=vulkan.spirv-module|nativeArtifactDescriptor.sourcePath=backend/vulkan/StorageBufferComputeShader.spvasm|nativeArtifactDescriptor.artifactPath=backend/vulkan/StorageBufferComputeShader.spv|nativeArtifactDescriptor.validationStatus=validated"
      "-DEXPECTED_NATIVE_ARTIFACT_DESCRIPTOR_JSON_FIELDS=target=vulkan|binaryKind=vulkan.spirv-module|sourcePath=backend/vulkan/StorageBufferComputeShader.spvasm|artifactPath=backend/vulkan/StorageBufferComputeShader.spv|validationStatus=validated"
      "-DEXPECTED_JSON_ARRAY_LENGTHS=artifacts=7|diagnostics.diagnostics=1"
      -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/package-inspect-v1.schema.json
      -DNATIVE_ARTIFACT_JSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/native-artifact-v0.schema.json
      -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py)
  crossgl_add_python_expect_test(
  ...
  add_test(NAME cglc_build_vulkan_storage_image_access_qualifier_native
    COMMAND ${CMAKE_COMMAND}
      ...
      "-DEXPECTED_REFLECTION_TARGET_FIELDS=readOnlyImage.sourceType=image2D|readOnlyImage.bindingClass=storageImage|readOnlyImage.descriptorType=VK_DESCRIPTOR_TYPE_STORAGE_IMAGE|readOnlyImage.storageClass=UniformConstant|readOnlyImage.spirvType=OpTypeImage<float, 2D, sampled=2, format=Rgba32f>|readOnlyImages.sourceType=image2D[IMAGE_COUNT]|readOnlyImages.arrayElementCount=2|writeOnlyImages.arrayElementCount=2|readWriteImages.arrayElementCount=2|slots.sourceType=int*|slots.descriptorType=VK_DESCRIPTOR_TYPE_STORAGE_BUFFER|colors.sourceType=vec4*|colors.storageBufferLayout.arrayStrideBytes=16"
