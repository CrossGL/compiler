...
crossgl_add_python_expect_test(
  ...
  DEFINITIONS
    ...
    -DJSON_SCHEMA=${CMAKE_CURRENT_SOURCE_DIR}/docs/schemas/debug-metadata-v11.schema.json
    -DJSON_SCHEMA_VALIDATOR=${CMAKE_CURRENT_SOURCE_DIR}/tools/validate_json_schema.py
    "-DEXPECTED_JSON_FIELDS=schemaVersion=11|targetDecision.requestedTarget=directx|targetDecision.selectedTarget=directx|targetDecision.selectedTargetPackageMode=unsupported|targetDecision.selectedTargetMissingCapabilityCount=2|targetDecision.selectedTargetDiagnosticCount=1|targetDecision.selectedTargetMissingCapabilityGroups.0.kind=backend|targetDecision.selectedTargetMissingCapabilityGroups.0.count=1|targetDecision.selectedTargetMissingCapabilityGroups.1.kind=diagnostic|targetDecision.selectedTargetMissingCapabilityGroups.1.count=1|targetDecision.diagnostics.0.code=directx.unsupported-runtime-resource-array|targetDecision.diagnostics.0.severity=error|targetDecision.diagnostics.0.capabilityGroups.0.kind=backend|targetDecision.diagnostics.0.capabilityGroups.0.count=1|targetDecision.diagnostics.0.capabilityGroups.1.kind=diagnostic|targetDecision.diagnostics.0.capabilityGroups.1.count=1"
    "-DEXPECTED_JSON_ARRAY_CONTAINS=targetDecision.selectedTargetMissingCapabilityGroups.0.capabilities=directx.backend.hlsl-lowering|targetDecision.selectedTargetMissingCapabilityGroups.1.capabilities=directx.diagnostic.directx.unsupported-runtime-resource-array|targetDecision.selectedTargetLegalizationCoreEvidenceIds=target-legalization.v1.directx.package-mode.unsupported|targetDecision.diagnostics.0.capabilityGroups.0.capabilities=directx.backend.hlsl-lowering|targetDecision.diagnostics.0.capabilityGroups.1.capabilities=directx.diagnostic.directx.unsupported-runtime-resource-array|targetDecision.diagnostics.0.legalizationCoreEvidenceIds=target-legalization.v1.directx.package-mode.unsupported"
    -DTARGET_EXPLANATION_ROOT=targetCapabilities
    -DTARGET_RECORD_ARRAY_FIELD=summaries
    "-DEXPECTED_TARGET_FIELDS=directx.packageBuildSupported=false|directx.packageMode=unsupported|directx.missingCapabilityGroups.0.kind=backend|directx.missingCapabilityGroups.1.kind=diagnostic"
    "-DEXPECTED_TARGET_ARRAY_CONTAINS=directx.missingCapabilityGroups.0.capabilities=directx.backend.hlsl-lowering|directx.missingCapabilityGroups.1.capabilities=directx.diagnostic.directx.unsupported-runtime-resource-array")
...
add_test(NAME cglc_explain_targets_metal_storage_buffer_array_unsupported_legalization
  COMMAND ${CMAKE_COMMAND}
    ...
    -DINPUT=${CROSSGL_METAL_STORAGE_BUFFER_ARRAY_UNSUPPORTED_SHADER}
    -DMODE=explain-targets
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|module=MetalStorageBufferArrayUnsupportedShader|buildableTargetCount=1|recommendedTarget=directx|recommendedPackageMode=source-package"
...
add_test(NAME cglc_target_decision_auto_skips_unsupported_native_storage_buffer_array
  COMMAND ${CMAKE_COMMAND}
    ...
    -DSTAGE=debug
    -DMODE=dump-stage
    "-DEXPECTED_JSON_FIELDS=schemaVersion=11|targetDecision.requestedTarget=auto|targetDecision.selectedTarget=directx|targetDecision.selectionReason=${CROSSGL_NATIVE_UNSUPPORTED_SOURCE_FALLBACK_SELECTION_REASON}|targetDecision.selectedTargetNativeImplemented=false|targetDecision.selectedTargetSourcePackageSupported=true|targetDecision.selectedTargetPackageBuildSupported=true|targetDecision.selectedTargetPackageMode=source-package|targetDecision.selectedTargetDiagnosticCount=0|targetDecision.fallbackTargetRecordCount=0"
    "-DEXPECTED_JSON_ARRAY_LENGTHS=targetDecision.diagnostics=0|targetDecision.fallbackTargets=0|targetDecision.viableTargets=1"
    "-DEXPECTED_JSON_ARRAY_CONTAINS=targetDecision.viableTargets=directx|targetDecision.nonViableTargets=metal|targetDecision.nonViableTargets=vulkan|targetDecision.nonViableTargets=opengl|targetDecision.selectedTargetMissingCapabilities=directx.backend.native-dxil-package"
    -DTARGET_EXPLANATION_ROOT=targetCapabilities
    -DTARGET_RECORD_ARRAY_FIELD=summaries
    "-DEXPECTED_TARGET_FIELDS=metal.nativeImplemented=true|metal.packageBuildSupported=false|metal.packageMode=unsupported|vulkan.nativeImplemented=true|vulkan.packageBuildSupported=false|vulkan.packageMode=unsupported|directx.packageBuildSupported=true|directx.packageMode=source-package"
...
add_test(NAME cglc_explain_targets_directx_graphics_storage_buffer_source_package_evidence
  COMMAND ${CMAKE_COMMAND}
    ...
    -DMODE=explain-targets
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|module=DirectXGraphicsStorageBufferResourceShader|buildableTargetCount=2"
...
add_test(NAME cglc_explain_targets_metal_graphics_descriptor_array_native_evidence
  COMMAND ${CMAKE_COMMAND}
    ...
    -DMODE=explain-targets
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|module=MetalGraphicsDescriptorArrayShader|buildableTargetCount=1|recommendedTarget=metal|recommendedPackageMode=native"
...
add_test(NAME cglc_explain_targets_opengl_graphics_descriptor_array_source_package_evidence
  COMMAND ${CMAKE_COMMAND}
    ...
    -DMODE=explain-targets
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|module=OpenGLGraphicsDescriptorArrayResourcesShader|buildableTargetCount=3"
...
add_test(NAME cglc_explain_targets_vulkan_runtime_texture_sampler_descriptor_array_native_evidence
  COMMAND ${CMAKE_COMMAND}
    ...
    -DMODE=explain-targets
    "-DEXPECTED_JSON_FIELDS=schemaVersion=1|module=VulkanRuntimeTextureSamplerDescriptorArrayPolicyShader|buildableTargetCount=2|recommendedTarget=vulkan|recommendedPackageMode=native"
    ...
    "-DEXPECTED_TARGET_ARRAY_CONTAINS=vulkan.requiredCapabilities=vulkan.backend.vulkan-prototype-package|vulkan.requiredCapabilities=vulkan.stage.compute-kernel|vulkan.requiredCapabilities=vulkan.execution.workgroup-size|vulkan.requiredCapabilities=vulkan.resource.runtime-descriptor-array|vulkan.requiredCapabilities=vulkan.resource.runtime-texture-descriptor-array|vulkan.requiredCapabilities=vulkan.resource.runtime-sampler-descriptor-array|vulkan.requiredCapabilities=vulkan.layout.runtime-array|vulkan.requiredCapabilities=vulkan.resource.descriptor-array"
    -P ${CMAKE_CURRENT_SOURCE_DIR}/tests/cmake/ExpectCommand.cmake)
