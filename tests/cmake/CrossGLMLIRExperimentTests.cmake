if(DEFINED CROSSGL_MLIR_EXPERIMENT_VERIFY_SCRIPT)
  ...
  foreach(required_var IN ITEMS MLIR_OPT INPUT_MLIR BUILD_DIR EXPERIMENT_TARGET)
  ...
  foreach(required_marker IN LISTS
  ...
  foreach(output_marker IN LISTS
...
if(NOT CROSSGL_ENABLE_MLIR_EXPERIMENTAL)
  ...
  if(NOT EXISTS
      "${CMAKE_CURRENT_SOURCE_DIR}/${CROSSGL_MLIR_EXPERIMENT_MINIMAL_FIXTURE}")
    list(APPEND CROSSGL_MLIR_EXPERIMENT_VERIFIER_MISSING_REASONS
      "minimal compute fixture missing")
  endif()
  if(NOT EXISTS "${CROSSGL_MLIR_EXPERIMENT_MINIMAL_VERIFY_INPUT}")
    list(APPEND CROSSGL_MLIR_EXPERIMENT_VERIFIER_MISSING_REASONS
      "real MLIR verifier fixture missing")
  endif()
...
if(NOT CROSSGL_MLIR_EXPERIMENT_VERIFIER_STATUS STREQUAL "toolchain-available")
  add_test(NAME "${CROSSGL_MLIR_EXPERIMENT_MINIMAL_VERIFY_TEST}"
    COMMAND ${CMAKE_COMMAND} -E echo
      "SKIP: CrossGL MLIR experiment real MLIR minimal compute verifier unavailable: ${CROSSGL_MLIR_EXPERIMENT_VERIFIER_SKIP_REASON}")
  set_tests_properties("${CROSSGL_MLIR_EXPERIMENT_MINIMAL_VERIFY_TEST}" PROPERTIES
  ...
  add_test(NAME "${CROSSGL_MLIR_EXPERIMENT_MINIMAL_VERIFY_TEST}"
    COMMAND ${CMAKE_COMMAND}
      ...
      "-DINPUT_MLIR=${CROSSGL_MLIR_EXPERIMENT_MINIMAL_VERIFY_INPUT}"
  ...
  set_tests_properties("${CROSSGL_MLIR_EXPERIMENT_MINIMAL_VERIFY_TEST}" PROPERTIES
    ...
    PROCESSORS 1
    REQUIRED_FILES "${CROSSGL_MLIR_EXPERIMENT_MINIMAL_VERIFY_INPUT}")
  message(STATUS
    "CrossGL MLIR experiment verifier harness registered: "
    "fixture=${CROSSGL_MLIR_EXPERIMENT_MINIMAL_FIXTURE}; "
    "verifier_input=${CROSSGL_MLIR_EXPERIMENT_MINIMAL_VERIFY_INPUT_RELATIVE}; "
